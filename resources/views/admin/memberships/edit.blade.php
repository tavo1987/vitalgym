        ...
        <div class="box-body">
            <form action="{{ route('admin.memberships.store', $plan) }}" method="post" autocomplete="off">
                ...
                <div class="form-group {{  $errors->has('customer_id') ? 'has-error': '' }}">
                    ...
                    <select name="customer_id" class="form-control select2" tabindex="-1">
                        ...
                        @foreach($customers as $c)
                            <option  value="{{ $customer->id }}" {{ old('customer_id', $customer->id) == $c->id ? 'selected' : '' }}>
                ...
                <div class="form-group {{ $errors->has('membership_quantity') ? ' has-error': '' }}">
                    ...
                    <input class="form-control" type="number" name="membership_quantity" value="{{ old('membership_quantity', $payment->memership_quantity) ?? 1 }}">
                ...
                <div class="lg:tw-flex tw-mb-4">
                    <div class="form-group date lg:tw-w-1/2 lg:tw-pr-2 {{ $errors->has('date_start') ? ' has-error': '' }}">
                        ...
                        <input name="date_start" type="text" class="form-control datepicker" value="{{ old('date_start', $membership->date_start) }}">
                    ...
                    <div class="form-group date lg:tw-w-1/2 lg:tw-pl-2 date {{ $errors->has('date_end') ? ' has-error': '' }}">
                        ...
                        <input name="date_end" type="text" class="form-control datepicker" value="{{ old('date_end', $membership->date_end) }}">
