        ...
        <div class="box-body">
            <form class="tw-rounded-lg tw-shadow tw-bg-grey-lightest tw-px-10 tw-py-6" action="{{ route('admin.users.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group {{ $errors->has('avatar') ? ' has-error': '' }}">
                    <img class="tw-w-48 tw-h-48 tw-rounded-full tw-mb-4" src="{{ Storage::url('avatars/default-avatar.jpg') }}" alt="Avatar">
                ...
                <div class="xl:tw-flex xl:tw-flex-wrap">
                    ...
                    <div class="form-group xl:tw-w-1/2 xl:tw-pl-2 {{ $errors->has('phone') ? ' has-error': '' }}">
                    ...
                    <div class="form-group xl:tw-w-1/2 xl:tw-pr-2 {{ $errors->has('cell_phone') ? ' has-error': '' }}">
                        <label>Celular:</label>
